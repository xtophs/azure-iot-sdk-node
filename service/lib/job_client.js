...
var shared_access_signature_1 = require("./shared_access_signature");
...
var JobClient = (function () {
    ...
    JobClient.fromConnectionString = function (connectionString) {
        ...
        var sas = shared_access_signature_1.SharedAccessSignature.create(cn.HostName, cn.SharedAccessKeyName, cn.SharedAccessKey, azure_iot_common_1.anHourFromNow());
        var config = {
            host: cn.HostName,
    ...
    JobClient.fromSharedAccessSignature = function (sharedAccessSignature) {
        ...
        var sas = shared_access_signature_1.SharedAccessSignature.parse(sharedAccessSignature);
        var config = {
            host: sas.sr,
